...
int	main(int ac, char **av, char **env)
{
	...
	t_stat	*s4;
	char	*str;
	char	d1[33] = "/Users/msorin/avm_cledant/auteur";
	char	d2[37] = "/Users/msorin/avm_cledant/auteur_bis";
	char	d3[43] = "/Users/msorin/Desktop/gh_ft_ls/test/test.c";
	char	d4[36] = "/Users/msorin/avm_cledant/Makefile";
	t_stat	test;
	...
	// {
		...
		s1 = malloc(sizeof(t_stat));
		s2 = malloc(sizeof(t_stat));
		s3 = malloc(sizeof(t_stat));
		s4 = malloc(sizeof(t_stat));
		...
		// 	print_stat(s1);
		// }
		if (lstat(d1, s1)) //if (lstat(dir, s2))
			perror("arfl");
		else
		{
			write(1, "lstat : ", 8);
		...
		if (lstat(d2, s2)) //if (lstat(dir, s2))
			perror("arfl");
		else
		{
			write(1, "lstat : ", 8);
		...
		if (lstat(d3, s3)) //if (lstat(dir, s3))
			perror("arfl");
		else
		{
			write(1, "lstat : ", 8);
		...
		if (lstat(d4, s4)) //if (lstat(dir, s4))
			perror("arfl");
		else
		{
			write(1, "lstat : ", 8);
